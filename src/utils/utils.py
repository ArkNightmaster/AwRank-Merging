...
torch.serialization.add_safe_globals(
    [
        "ClassficationHead",
        "src.model.modeling.ClassficationHead",
        "src.model.modeling.Pooler",
        "src.model.modeling.BertEmbeddings",
        "src.model.modeling.BertEncoder",
        "src.model.modeling.BertPooler",
    ]
)
